...
\solution The Python code plots $x(t)$ in Fig. \eqref{fig:xt}.
\begin{lstlisting}
    wget https://raw.githubusercontent.com/samar2605/EE3900/master/charger/codes/1_1.py
\end{lstlisting}
\begin{figure}[!ht]
...
\solution The Python code verifies \eqref{eq:one-Z-real}.
\begin{lstlisting}
    wget https://raw.githubusercontent.com/samar2605/EE3900/master/charger/codes/2_3.py
\end{lstlisting}
\begin{figure}[!ht]
...
\solution The Python code verifies \eqref{eq:one-Z-real}.
\begin{lstlisting}
    wget https://raw.githubusercontent.com/samar2605/EE3900/master/charger/codes/2_6.py
\end{lstlisting}
\begin{figure}[!ht]
