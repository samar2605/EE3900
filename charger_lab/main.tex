...
\begin{enumerate}
    \item Step-down transformer (12-0-12 , 750mA)
...
\begin{figure}[!htb]
    \includegraphics[width=\columnwidth]{figs/circuit.jpeg}
    \caption{Schematic diagram of the circuit.}
    \label{fig:ckt}
\end{figure}
\subsection{Transformer}
The transformer used is a centre-tapped 12-0-12, 750mA step-down 
...
The full-wave rectifier is realized using four Silicon diodes arranged in a
wheatstone bridge form as shown in Fig. \ref{fig:ckt}. The output waveform at this
...
\section{Results}
The pictures of the waveforms at each stage as shown ahead.
\begin{enumerate}
...
\begin{figure}[!ht]
    ...
    \caption{Output AC waveform at transformer stage across BF (18 V peak).}
    \label{fig:transformer}
\end{figure}

\begin{figure}[!ht]
    \includegraphics[width=\columnwidth]{figs/rectifier.jpeg}
    \caption{Output half-wave rectified waveform across diode across BC (18 V peak).}
    \label{fig:rectifier}
\end{figure}
\begin{figure}[!ht]
    \includegraphics[width=\columnwidth]{figs/filter.jpeg}
    \caption{Output DC waveform at filter stage across IG (18 V).}
    \label{fig:filter}
\end{figure}
\begin{figure}[!ht]
...
\begin{enumerate}
    \item Implementation of a circuit in breadboard followed by PCB design
    ...
    \item Handling different equipment such as solder, oscilloscope, PCB and so on to realize a circuit
    \item Understanding of fourier series in practical aspects
\end{enumerate}
\end{document}
