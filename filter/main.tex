...
\lstinputlisting{./codes/A1_3.c}
\lstinputlisting{./codes/A1_3point3.py}
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=\columnwidth]{./figs/A1_3point3.png}
\end{center}
\captionof{figure}{}
\label{fig:A1_3point3}	
\end{figure}
\end{enumerate}
\section{$Z$-transform}
\begin{enumerate}[label=\thesection.\arabic*]
...
\solution The following code plots Fig. \ref{fig:dtft}.
\begin{lstlisting}
wget https://raw.githubusercontent.com/samar2605/EE3900/master/Assignment%201/codes/dtft.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{./figs/dtft}
