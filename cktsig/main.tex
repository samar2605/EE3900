...
\end{align}
The python code plots the graph below.
\begin{lstlisting}
    wget https://raw.githubusercontent.com/samar2605/EE3900/master/cktsig/codes/2_6.py
\end{lstlisting}
\begin{figure}[!htb]
...
\begin{lstlisting}
    wget https://raw.githubusercontent.com/samar2605/EE3900/master/cktsig/codes/2_7.cir
\end{lstlisting}simulates the given circuit and the generated output is depicted in Fig. \eqref{fig:v1-t}
\end{enumerate}
...
The Python code plots the graph below.
\begin{lstlisting}
    wget https://raw.githubusercontent.com/samar2605/EE3900/master/cktsig/codes/3_4.py
\end{lstlisting}
\begin{figure}[!htb]
...
\solution The ngspice script
\begin{lstlisting}
    wget https://raw.githubusercontent.com/samar2605/EE3900/master/cktsig/codes/3_5.cir
\end{lstlisting}
